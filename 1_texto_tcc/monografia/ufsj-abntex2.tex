...
% ---------------------------------------------------------------------------------------------
\titulo{Metodologia para Decompor uma Aplicação Monolítica em Microsserviços}
\autor{Davi Gomes Pinto Coelho}
...
\preambulo{Monografia apresentada como requisito da disciplina de Projeto Orientado em Computação I do Curso de Bacharelado em Ciência da Computação da UFSJ.}
% ---
...
\include{03_trabalhos_relacionados}
\include{04_metodologia}
\include{05_resultados_discussoes}
